...
---------------------------------------------------------------------------------
--PgHydro Output Extension Version 6.0 of 25/07/2017
---------------------------------------------------------------------------------
...
----------------------
DROP TABLE IF EXISTS pgh_output.geoft_bho_trecho_drenagem;

CREATE TABLE pgh_output.geoft_bho_trecho_drenagem
(
  drn_pk integer,
  cotrecho integer,
  noorigem integer,
...
DROP TABLE IF EXISTS pgh_output.geoft_bho_area_drenagem;

CREATE TABLE pgh_output.geoft_bho_area_drenagem
(
  dra_pk integer,
  idbacia integer,
  cotrecho integer,
...
DROP TABLE IF EXISTS pgh_output.geoft_bho_curso_dagua;

CREATE TABLE pgh_output.geoft_bho_curso_dagua
(
  wtc_pk integer,
  idcda integer,
  cocursodag character varying,
...
DROP TABLE IF EXISTS pgh_output.geoft_bho_ponto_drenagem;

CREATE TABLE pgh_output.geoft_bho_ponto_drenagem
(
  drp_pk integer,
  idponto integer,
  cocursodag character varying,
...
DROP TABLE IF EXISTS pgh_output.geoft_bho_linha_costa;

CREATE TABLE pgh_output.geoft_bho_linha_costa
(
...
--TABLE pgh_output.geoft_bho_trecho_drenagem

TRUNCATE pgh_output.geoft_bho_trecho_drenagem;

INSERT INTO pgh_output.geoft_bho_trecho_drenagem
SELECT
drn_pk,
...
--TABLE pgh_output.geoft_bho_area_drenagem

TRUNCATE pgh_output.geoft_bho_area_drenagem;

INSERT INTO pgh_output.geoft_bho_area_drenagem
SELECT
dra_pk,
...
--TABLE pgh_output.geoft_bho_curso_dagua

TRUNCATE pgh_output.geoft_bho_curso_dagua;

INSERT INTO pgh_output.geoft_bho_curso_dagua
SELECT
wtc.wtc_pk,
wtc.wtc_pk as idcda,
wtc.wtc_cd_pfafstetterwatercourse as cocursodag,
...
TRUNCATE pgh_output.geoft_bho_ponto_drenagem;

INSERT INTO pgh_output.geoft_bho_ponto_drenagem
...
--TABLE pgh_output.geoft_bho_linha_costa

TRUNCATE pgh_output.geoft_bho_linha_costa;

INSERT INTO pgh_output.geoft_bho_linha_costa 
SELECT

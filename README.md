...
Download the last pghydro stable release zip file(.rar) from the site https://github.com/pghydro/pghydro/releases, unzip, copy and paste *.sql and *.control files to \PostgreSQL\x.x\share\extension
